...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || '9_6_87b3_1b58_cab3').trim(),
  DATABASE:
  ...
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'dwells',Theone
  ...
  ANTI_DELETE: (process.env.ANTI_DELETE || 'g').trim(),
